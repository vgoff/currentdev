...
class Filter extends React.Component {
  state = {
    ...
    types: this.props.thingsInfo.types,
    locations: this.props.thingsInfo.locations,
  }
  ...
  typeChanged(event, data) {
    ...
    this.serverRequest =
      axios
      // I have to figure out some way to get the value from the other
        .get(this.props.data.url + 'orderParam=' + this.props.data.orderParam + '&order=' + this.props.data.order + '&type=' + this.props.data.type + "&city=" + this.props.data.city + "&term=" + this.props.data.search + "&type=" + val)
        .then(function(result) {
          _this.props.changeThings(result.data)
          _this.props.onLoadChange({loading: false});
        })
